...
print(lst)
# ******************************************************************************************************************************
#6/19/2025 DATA TYPES and Collections: 
# ******************************************************************************************************************************
...
#Strings - ordered, immutable, indexible 
...
# LISTS - are changable objects (indexed, ordered, mutable)
...
#tuple -  indexed, ordered, allows duplicates, immutable; can't change or add anything to a tuple. 
### used when data will never change 

tuple_scoops = (1,2,3,4,6) 
print(tuple_scoops)

#sets - no duplicates, not ordered, not mutable (cant change)
extrano = {1,5,7}
...
#dictionaries - unordered before pytohn 3.7, ordered after 3.7; ky-value pairs, mutable, not indexible by number (instead indexed by key)
#key/value pair 
